...
Также порой непонятно является ли определённый класс Синглтоном или обычным классом, что может привести к его неверному использованию (попытка создания несокльких инстансов класса).
