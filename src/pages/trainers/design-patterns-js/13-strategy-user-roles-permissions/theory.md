...
В компоненте `Article.js` уже реализовано отображение статьи с кнопками действия (редактирование/удаление) для каждой из ролей. Внутри компонента происходит выбор стратегии проверки прав на основе роли пользователя.
