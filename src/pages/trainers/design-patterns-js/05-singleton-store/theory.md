...
Как мы уже выяснили, Singleton — это один «глобальный» объект для координации действий системы. То есть по сути Singleton может быть «глобальным» хранилищем каких-то общих для всей системы данных с методами их добавления, извлечения и удаления.
