...
Если <a href="/web-platform-site/trainers/design-patterns-js/04-singleton-theory">паттерн Singleton</a> отвечает за создание «единственного и неповторимого» объекта, то паттерн `Prototype` (Прототип), напротив, про создание объектов на основе общего шаблона. То есть если нужно создать много однотипных объектов, не обязательно создавать их все с нуля. Можно взять заготовку, например, с уже готовыми общими функциями:
