...
Цель модульности — разделить, декомпозировать большую и сложную программу на отдельные части. Какие от этого подхода преимущества:

- повторяющиеся части можно будет переиспользовать
...
Изначально паттерн модуль был задуман для реализации принципа инкапсуляции (сокрытие приватных частей внутри модуля, открытие публичных частей наружу потребителю) для классов.
