...
![Сила паттернов](../assets/pattern-doge.jpg)
...
Некоторые паттерны относятся только к TS или React, а часть из них, как структуры данных и алгоритмы, можно реализовать в любом языке программирования.
...
![Антипаттерн](../assets/antipattern.jpg)
