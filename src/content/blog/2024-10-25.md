...
- появились результаты опроса [State of CSS 2024](https://2024.stateofcss.com), интересные факты: 25% опрошенных создают свои дизайны сразу в CSS; большинство CSS-фич уже вышло, но при этом всё ещё есть болит кроссбраузерность; самые любимые фичи `:has()` и subgrid
