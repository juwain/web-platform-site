...
- обновились LST версии Node.js: в [v20.12.0](https://nodejs.org/en/blog/release/v20.12.0) бэкпортированы crypto.hash(), более быстрый, чем createHash(), загрузка и парсинг переменных окружения с process.loadEnvFile(path) и util.parseEnv(content), стилизация вывода текста util.styleText; в [v18.20.0](https://nodejs.org/en/blog/release/v18.20.0) добавлены импорт-атрибуты import "foo" with { ... }, а также dirent.path заменён на dirent.parentPath (следом доехали секьюрные апдейты v20.12.1 и v18.20.1)
