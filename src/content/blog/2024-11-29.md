...
- вышел [Angular 19](https://blog.angular.dev/meet-angular-v19-7b29dfd05b84): в современном фронтенде, если фреймворк не поддерживает SSR и гидрацию, а также сигналы, конкуренцию среди модной-молодёжной аудитории уже не выдержать; и Angular в этом плане снова с строю:
...
- вышел [TypeScript 5.7](https://devblogs.microsoft.com/typescript/announcing-typescript-5-7/):
  ...
  - поддержано API Node.js 22 [module.enableCompileCache()](https://github.com/nodejs/node/pull/54501) для более быстрого выполнения повторных операций
...
- базовые типы TS для React в доках разбросаны повсюду, а тут [собраны в одно месте](https://www.jacobparis.com/content/react-ts):
