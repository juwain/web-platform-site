...
- [обновления Chrome 124](https://developer.chrome.com/release-notes/124):
...
- [обновления Firefox 125](https://developer.mozilla.org/en-US/docs/Mozilla/Firefox/Releases/125):
  - `align-content` в добавок к гридам и флексбоксам теперь работает и с `display: block`
  - поддержан `Intl.Segmenter` и Popover API
- [обновления Next.js до версии 14.2](https://nextjs.org/blog/next-14-2):
...
- [современные CSS-фишечки в Campfire](https://dev.37signals.com/modern-css-patterns-and-techniques-in-campfire/), используются:
